...
public class DataGangguan extends javax.swing.JFrame {
private Connection conn = new Koneksi().connect();
   ...
   protected void datatable(){
        ...
        String cariitem = txtCari.getText();
                try {
         String sql  = "SELECT kd_lapor,tgl,layanan,kpl_area,ruang,telepon,keluhan,teknisi,tlp,tgl_p,status FROM i_pengaduan where status like '%"+"Menunggu"+"%' order by tgl asc"  ;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("P O P  U P   D A T A  G A N G G U A N");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addComponent(jLabel15, javax.swing.GroupLayout.DEFAULT_SIZE, 859, Short.MAX_VALUE)
        );
    ...
    private void tblDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblDataMouseClicked
        ...
        PenentuanTeknisi pTek = new PenentuanTeknisi();
        pTek.dg= this;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataGangguan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DataGangguan().setVisible(true);
            }
        });
    }
